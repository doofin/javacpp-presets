...
import static org.bytedeco.libtorch.global.libtorch.Layout;
import static org.bytedeco.libtorch.global.libtorch.MemoryFormat;
...
public class TensorImpl extends Pointer {
   ...
   */
  public TensorImpl(
        @ByVal @Cast("c10::Storage*") Pointer storage,
        @ByVal @Cast("c10::DispatchKeySet*") Pointer arg1,
        @Const @ByRef TypeMeta data_type) { super((Pointer)null); allocate(storage, arg1, data_type); }
  private native void allocate(
        @ByVal @Cast("c10::Storage*") Pointer storage,
        @ByVal @Cast("c10::DispatchKeySet*") Pointer arg1,
        @Const @ByRef TypeMeta data_type);

  /**
   * Construct a 1-dim 0 size tensor that doesn't have a storage.
   */
  public TensorImpl(@ByVal @Cast("c10::DispatchKeySet*") Pointer arg0, @Const @ByRef TypeMeta data_type, @ByVal @Cast("c10::optional<c10::Device>*") Pointer device_opt) { super((Pointer)null); allocate(arg0, data_type, device_opt); }
  private native void allocate(@ByVal @Cast("c10::DispatchKeySet*") Pointer arg0, @Const @ByRef TypeMeta data_type, @ByVal @Cast("c10::optional<c10::Device>*") Pointer device_opt);

  // Legacy constructors so I don't have to go update call sites.
  // TODO: When Variable is added, delete these constructors
  
  
  public TensorImpl(@ByVal TensorImpl arg0) { super((Pointer)null); allocate(arg0); }
  private native void allocate(@ByVal TensorImpl arg0);
  public native @ByRef @Name("operator =") TensorImpl put(@ByVal TensorImpl arg0);
   ...
   */
  public native @ByVal @Cast("c10::IntArrayRef*") Pointer sizes();

  /**
   * Return a reference to the strides of this tensor.  This reference remains
   * valid as long as the tensor is live and not restrided.
   */
  public native @ByVal @Cast("c10::IntArrayRef*") Pointer strides();
   ...
   * operations.
   */
  public native @Cast("const c10::Storage*") @ByRef Pointer storage();
   ...
   * it is (e.g., int, float, ...)
   */
  public native @Const @ByRef TypeMeta dtype();
   ...
   */
  public native void set_sizes_contiguous(@ByVal @Cast("c10::IntArrayRef*") Pointer new_size);
   ...
   * this is the responsibility of the caller
   */
  public native void set_sizes_and_strides(@ByVal @Cast("c10::IntArrayRef*") Pointer new_size, @ByVal @Cast("c10::IntArrayRef*") Pointer new_stride);
   ...
   */
  public native @Cast("bool") boolean has_compatible_shallow_copy_type(@ByVal @Cast("c10::DispatchKeySet*") Pointer from);
   ...
   */
  public native @Cast("c10::DeviceType") short device_type();
   ...
   */
  public native void Reshape(@Cast("int64_t*") @StdVector LongPointer dims);
  public native void Reshape(@Cast("int64_t*") @StdVector LongBuffer dims);
  public native void Reshape(@Cast("int64_t*") @StdVector long[] dims);
