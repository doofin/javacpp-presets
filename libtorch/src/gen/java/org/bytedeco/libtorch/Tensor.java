...
public class Tensor extends Pointer {
  ...
  public Tensor(
        @ByVal @Cast("c10::intrusive_ptr<at::TensorImpl,at::UndefinedTensorImpl>*") Pointer tensor_impl) { super((Pointer)null); allocate(tensor_impl); }
  private native void allocate(
        @ByVal @Cast("c10::intrusive_ptr<at::TensorImpl,at::UndefinedTensorImpl>*") Pointer tensor_impl);
  ...
  public native @Cast("const c10::intrusive_ptr<at::TensorImpl,at::UndefinedTensorImpl>*") @ByRef Pointer getIntrusivePtr();
  ...
  public native @StdString @Name("toString") BytePointer toBytePointer();

  public native @ByVal @Cast("at::IntArrayRef*") Pointer sizes();
  public native @ByVal @Cast("at::IntArrayRef*") Pointer strides();
  // See impl::get_opt_names in ATen/NamedTensor.h for docs.
  public native @ByVal @Cast("at::optional<at::DimnameList>*") Pointer opt_names();
  // See impl::get_names in ATen/NamedTensor.h for docs.
  public native @ByVal @Cast("at::DimnameList*") Pointer names();
  public native @Cast("int64_t") long ndimension();

  public native @Cast("bool") boolean is_contiguous(@ByVal(nullValue = "at::MemoryFormat::Contiguous") @Cast("at::MemoryFormat*") Pointer memory_format);
  public native @Cast("bool") boolean is_contiguous();

  public native @Cast("bool") boolean is_non_overlapping_and_dense();

  public native @ByVal @Cast("at::MemoryFormat*") Pointer suggest_memory_format(
  ...
  public native @ByRef DeprecatedTypeProperties type();
  public native @ByVal @Cast("at::DispatchKeySet*") Pointer key_set();
  public native @ByVal ScalarType scalar_type();
  public native @Cast("bool") boolean has_storage();
  public native @Cast("const at::Storage*") @ByRef Pointer storage();
  public native @Cast("bool") boolean is_alias_of(@Const @ByRef Tensor other);
  public native @ByVal Tensor toType(@ByVal ScalarType t);
  public native @ByVal Tensor toBackend(@ByVal Backend b);
  ...
  public native @ByVal @Cast("at::QuantizerPtr*") Pointer quantizer();
  ...
  // Return a `TensorAccessor` for CPU `Tensor`s. You have to specify at::Scalar type and
  // dimension.
  

  // Return a `GenericPackedTensorAccessor` for CUDA `Tensor`s. You have to specify at::Scalar type and
   ...
   *  non-at::Scalar (i.e. its data has more than one element) and requires
   ...
   *      None values can be specified for at::Scalar Tensors or ones that
  ...
  //example
  //Tensor * add(Tensor & b);
  public native void backward(@Const @ByRef(nullValue = "at::Tensor({})") Tensor gradient, @ByVal(nullValue = "c10::optional<bool>(c10::nullopt)") @Cast("c10::optional<bool>*") Pointer retain_graph, @Cast("bool") boolean create_graph/*=false*/);
  ...
  public native @ByRef Tensor rename_(@ByVal @Cast("c10::optional<at::DimnameList>*") Pointer names);
  public native @ByVal Tensor rename(@ByVal @Cast("c10::optional<at::DimnameList>*") Pointer names);
  public native @ByVal Tensor align_to(@ByVal @Cast("at::DimnameList*") Pointer names);
  public native @ByVal Tensor align_to(@ByVal @Cast("at::DimnameList*") Pointer order, @Cast("int64_t") long ellipsis_idx);
  public native @ByVal Tensor align_as(@Const @ByRef Tensor other);
  public native @ByVal Tensor refine_names(@ByVal @Cast("at::DimnameList*") Pointer names);
  public native @ByVal Tensor unflatten(@ByVal Dimname dim, @ByVal @Cast("at::IntArrayRef*") Pointer sizes, @ByVal @Cast("at::DimnameList*") Pointer names);
  public native @ByVal Tensor unflatten(@Cast("int64_t") long dim, @ByVal @Cast("at::IntArrayRef*") Pointer sizes, @ByVal @Cast("at::DimnameList*") Pointer names);
  ...
  public native @ByVal Tensor add(@Const @ByRef Tensor other, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor add(@Const @ByRef Tensor other);
  public native @ByRef Tensor add_(@Const @ByRef Tensor other, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByRef Tensor add_(@Const @ByRef Tensor other);
  public native @ByVal Tensor add(@ByVal Scalar other, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor add(@ByVal Scalar other);
  public native @ByRef Tensor add_(@ByVal Scalar other, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByRef Tensor add_(@ByVal Scalar other);
  public native @ByVal Tensor addmv(@Const @ByRef Tensor mat, @Const @ByRef Tensor vec, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor addmv(@Const @ByRef Tensor mat, @Const @ByRef Tensor vec);
  public native @ByRef Tensor addmv_(@Const @ByRef Tensor mat, @Const @ByRef Tensor vec, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByRef Tensor addmv_(@Const @ByRef Tensor mat, @Const @ByRef Tensor vec);
  public native @ByVal Tensor addr(@Const @ByRef Tensor vec1, @Const @ByRef Tensor vec2, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor addr(@Const @ByRef Tensor vec1, @Const @ByRef Tensor vec2);
  public native @ByRef Tensor addr_(@Const @ByRef Tensor vec1, @Const @ByRef Tensor vec2, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  ...
  public native @ByVal Tensor argmax(@ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor argmax();
  public native @ByVal Tensor argmin(@ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer dim, @Cast("bool") boolean keepdim/*=false*/);
  ...
  public native @ByVal Tensor as_strided(@ByVal @Cast("at::IntArrayRef*") Pointer size, @ByVal @Cast("at::IntArrayRef*") Pointer stride, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer storage_offset);
  public native @ByVal Tensor as_strided(@ByVal @Cast("at::IntArrayRef*") Pointer size, @ByVal @Cast("at::IntArrayRef*") Pointer stride);
  public native @ByRef Tensor as_strided_(@ByVal @Cast("at::IntArrayRef*") Pointer size, @ByVal @Cast("at::IntArrayRef*") Pointer stride, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer storage_offset);
  public native @ByRef Tensor as_strided_(@ByVal @Cast("at::IntArrayRef*") Pointer size, @ByVal @Cast("at::IntArrayRef*") Pointer stride);
  ...
  public native @ByVal Tensor baddbmm(@Const @ByRef Tensor batch1, @Const @ByRef Tensor batch2, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor baddbmm(@Const @ByRef Tensor batch1, @Const @ByRef Tensor batch2);
  public native @ByRef Tensor baddbmm_(@Const @ByRef Tensor batch1, @Const @ByRef Tensor batch2, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByRef Tensor baddbmm_(@Const @ByRef Tensor batch1, @Const @ByRef Tensor batch2);
  public native @ByVal Tensor bernoulli(@ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByVal Tensor bernoulli();
  public native @ByRef Tensor bernoulli_(@Const @ByRef Tensor p, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByRef Tensor bernoulli_(@Const @ByRef Tensor p);
  public native @ByRef Tensor bernoulli_(double p/*=0.5*/, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByRef Tensor bernoulli_();
  public native @ByVal Tensor bernoulli(double p, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByVal Tensor bernoulli(double p);
  public native @ByVal Tensor bincount(@Const @ByRef(nullValue = "at::Tensor({})") Tensor weights, @Cast("int64_t") long minlength/*=0*/);
  ...
  public native @StdVector Tensor chunk(@Cast("int64_t") long chunks, @Cast("int64_t") long dim/*=0*/);
  public native @StdVector Tensor chunk(@Cast("int64_t") long chunks);
  public native @ByVal Tensor clamp(@ByVal(nullValue = "c10::optional<at::Scalar>(c10::nullopt)") @Cast("c10::optional<at::Scalar>*") Pointer min, @ByVal(nullValue = "c10::optional<at::Scalar>(c10::nullopt)") @Cast("c10::optional<at::Scalar>*") Pointer max);
  public native @ByVal Tensor clamp();
  public native @ByRef Tensor clamp_(@ByVal(nullValue = "c10::optional<at::Scalar>(c10::nullopt)") @Cast("c10::optional<at::Scalar>*") Pointer min, @ByVal(nullValue = "c10::optional<at::Scalar>(c10::nullopt)") @Cast("c10::optional<at::Scalar>*") Pointer max);
  ...
  public native @ByVal Tensor contiguous(@ByVal(nullValue = "at::MemoryFormat::Contiguous") @Cast("at::MemoryFormat*") Pointer memory_format);
  ...
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer cummax(@Cast("int64_t") long dim);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer cummax(@ByVal Dimname dim);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer cummin(@Cast("int64_t") long dim);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer cummin(@ByVal Dimname dim);
  public native @ByVal Tensor cumprod(@Cast("int64_t") long dim, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor cumprod(@Cast("int64_t") long dim);
  public native @ByVal Tensor cumprod(@ByVal Dimname dim, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor cumprod(@ByVal Dimname dim);
  public native @ByVal Tensor cumsum(@Cast("int64_t") long dim, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor cumsum(@Cast("int64_t") long dim);
  public native @ByVal Tensor cumsum(@ByVal Dimname dim, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  ...
  public native @ByVal Tensor new_empty(@ByVal @Cast("at::IntArrayRef*") Pointer size, @Const @ByRef(nullValue = "at::TensorOptions({})") TensorOptions options);
  public native @ByVal Tensor new_empty(@ByVal @Cast("at::IntArrayRef*") Pointer size);
  public native @ByVal Tensor new_full(@ByVal @Cast("at::IntArrayRef*") Pointer size, @ByVal Scalar fill_value, @Const @ByRef(nullValue = "at::TensorOptions({})") TensorOptions options);
  public native @ByVal Tensor new_full(@ByVal @Cast("at::IntArrayRef*") Pointer size, @ByVal Scalar fill_value);
  public native @ByVal Tensor new_zeros(@ByVal @Cast("at::IntArrayRef*") Pointer size, @Const @ByRef(nullValue = "at::TensorOptions({})") TensorOptions options);
  public native @ByVal Tensor new_zeros(@ByVal @Cast("at::IntArrayRef*") Pointer size);
  ...
  public native @ByVal Tensor expand(@ByVal @Cast("at::IntArrayRef*") Pointer size, @Cast("bool") boolean implicit/*=false*/);
  public native @ByVal Tensor expand(@ByVal @Cast("at::IntArrayRef*") Pointer size);
  ...
  public native @ByVal Tensor flatten(@ByVal @Cast("at::DimnameList*") Pointer dims, @ByVal Dimname out_dim);
  ...
  public native @ByVal Tensor fft(@Cast("int64_t") long signal_ndim, @Cast("bool") boolean normalized/*=false*/);
  public native @ByVal Tensor fft(@Cast("int64_t") long signal_ndim);
  public native @ByVal Tensor ifft(@Cast("int64_t") long signal_ndim, @Cast("bool") boolean normalized/*=false*/);
  public native @ByVal Tensor ifft(@Cast("int64_t") long signal_ndim);
  public native @ByVal Tensor rfft(@Cast("int64_t") long signal_ndim, @Cast("bool") boolean normalized/*=false*/, @Cast("bool") boolean onesided/*=true*/);
  public native @ByVal Tensor rfft(@Cast("int64_t") long signal_ndim);
  public native @ByVal Tensor irfft(@Cast("int64_t") long signal_ndim, @Cast("bool") boolean normalized/*=false*/, @Cast("bool") boolean onesided/*=true*/, @ByVal(nullValue = "at::IntArrayRef({})") @Cast("at::IntArrayRef*") Pointer signal_sizes);
  public native @ByVal Tensor irfft(@Cast("int64_t") long signal_ndim);
  ...
  public native @ByVal Tensor index_put(@ByVal @Cast("at::TensorList*") Pointer indices, @Const @ByRef Tensor values, @Cast("bool") boolean accumulate/*=false*/);
  public native @ByVal Tensor index_put(@ByVal @Cast("at::TensorList*") Pointer indices, @Const @ByRef Tensor values);
  ...
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer kthvalue(@Cast("int64_t") long k, @Cast("int64_t") long dim/*=-1*/, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer kthvalue(@Cast("int64_t") long k);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer kthvalue(@Cast("int64_t") long k, @ByVal Dimname dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer kthvalue(@Cast("int64_t") long k, @ByVal Dimname dim);
  ...
  public native @ByVal Tensor log_softmax(@Cast("int64_t") long dim, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor log_softmax(@Cast("int64_t") long dim);
  public native @ByVal Tensor log_softmax(@ByVal Dimname dim, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  ...
  public native @ByVal Tensor logsumexp(@ByVal @Cast("at::IntArrayRef*") Pointer dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor logsumexp(@ByVal @Cast("at::IntArrayRef*") Pointer dim);
  public native @ByVal Tensor matmul(@Const @ByRef Tensor other);
  public native @ByVal Tensor matrix_power(@Cast("int64_t") long n);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer max(@Cast("int64_t") long dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer max(@Cast("int64_t") long dim);
  public native @ByVal Tensor max_values(@ByVal @Cast("at::IntArrayRef*") Pointer dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor max_values(@ByVal @Cast("at::IntArrayRef*") Pointer dim);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer max(@ByVal Dimname dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer max(@ByVal Dimname dim);
  public native @ByVal Tensor mean(@ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor mean();
  public native @ByVal Tensor mean(@ByVal @Cast("at::IntArrayRef*") Pointer dim, @Cast("bool") boolean keepdim/*=false*/, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer median(@Cast("int64_t") long dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer median(@Cast("int64_t") long dim);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer median(@ByVal Dimname dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer median(@ByVal Dimname dim);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer min(@Cast("int64_t") long dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer min(@Cast("int64_t") long dim);
  public native @ByVal Tensor min_values(@ByVal @Cast("at::IntArrayRef*") Pointer dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor min_values(@ByVal @Cast("at::IntArrayRef*") Pointer dim);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer min(@ByVal Dimname dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer min(@ByVal Dimname dim);
  public native @ByVal Tensor mm(@Const @ByRef Tensor mat2);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer mode(@Cast("int64_t") long dim/*=-1*/, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer mode();
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer mode(@ByVal Dimname dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer mode(@ByVal Dimname dim);
  ...
  public native @ByVal Tensor permute(@ByVal @Cast("at::IntArrayRef*") Pointer dims);
  ...
  public native @ByVal Tensor repeat(@ByVal @Cast("at::IntArrayRef*") Pointer repeats);
  public native @ByVal Tensor repeat_interleave(@Const @ByRef Tensor repeats, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer dim);
  public native @ByVal Tensor repeat_interleave(@Const @ByRef Tensor repeats);
  public native @ByVal Tensor repeat_interleave(@Cast("int64_t") long repeats, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer dim);
  public native @ByVal Tensor repeat_interleave(@Cast("int64_t") long repeats);
  public native @ByVal Tensor reshape(@ByVal @Cast("at::IntArrayRef*") Pointer shape);
  ...
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer prelu_backward(@Const @ByRef Tensor grad_output, @Const @ByRef Tensor weight);
  public native @ByVal Tensor hardshrink(@ByVal(nullValue = "at::Scalar(0.5)") Scalar lambd);
  ...
  public native @ByVal Tensor slice(@Cast("int64_t") long dim/*=0*/, @Cast("int64_t") long start/*=0*/, @Cast("int64_t") long end/*=9223372036854775807L*/, @Cast("int64_t") long step/*=1*/);
  public native @ByVal Tensor slice();
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer slogdet();
  public native @ByVal Tensor smm(@Const @ByRef Tensor mat2);
  public native @ByVal Tensor softmax(@Cast("int64_t") long dim, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor softmax(@Cast("int64_t") long dim);
  public native @ByVal Tensor softmax(@ByVal Dimname dim, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor softmax(@ByVal Dimname dim);
  public native @StdVector Tensor split(@Cast("int64_t") long split_size, @Cast("int64_t") long dim/*=0*/);
  public native @StdVector Tensor split(@Cast("int64_t") long split_size);
  public native @StdVector Tensor split_with_sizes(@ByVal @Cast("at::IntArrayRef*") Pointer split_sizes, @Cast("int64_t") long dim/*=0*/);
  public native @StdVector Tensor split_with_sizes(@ByVal @Cast("at::IntArrayRef*") Pointer split_sizes);
  ...
  public native @ByVal Tensor sspaddmm(@Const @ByRef Tensor mat1, @Const @ByRef Tensor mat2, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor sspaddmm(@Const @ByRef Tensor mat1, @Const @ByRef Tensor mat2);
  public native @ByVal Tensor stft(@Cast("int64_t") long n_fft, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer hop_length, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer win_length, @Const @ByRef(nullValue = "at::Tensor({})") Tensor window, @Cast("bool") boolean normalized/*=false*/, @Cast("bool") boolean onesided/*=true*/);
  public native @ByVal Tensor stft(@Cast("int64_t") long n_fft);
  public native @ByVal Tensor istft(@Cast("int64_t") long n_fft, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer hop_length, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer win_length, @Const @ByRef(nullValue = "at::Tensor({})") Tensor window, @Cast("bool") boolean center/*=true*/, @Cast("bool") boolean normalized/*=false*/, @Cast("bool") boolean onesided/*=true*/, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer length);
  ...
  public native @ByVal Tensor sum(@ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor sum();
  public native @ByVal Tensor sum(@ByVal @Cast("at::IntArrayRef*") Pointer dim, @Cast("bool") boolean keepdim/*=false*/, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor sum_to_size(@ByVal @Cast("at::IntArrayRef*") Pointer size);
  ...
  public native @ByVal Tensor std(@ByVal @Cast("at::IntArrayRef*") Pointer dim, @Cast("bool") boolean unbiased/*=true*/, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor std(@ByVal @Cast("at::IntArrayRef*") Pointer dim);
  public native @ByVal Tensor prod(@ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor prod();
  public native @ByVal Tensor prod(@Cast("int64_t") long dim, @Cast("bool") boolean keepdim/*=false*/, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  public native @ByVal Tensor prod(@Cast("int64_t") long dim);
  public native @ByVal Tensor prod(@ByVal Dimname dim, @Cast("bool") boolean keepdim/*=false*/, @ByVal(nullValue = "c10::optional<at::ScalarType>(c10::nullopt)") @Cast("c10::optional<at::ScalarType>*") Pointer dtype);
  ...
  public native @ByVal Tensor flip(@ByVal @Cast("at::IntArrayRef*") Pointer dims);
  public native @ByVal Tensor fliplr();
  public native @ByVal Tensor flipud();
  public native @ByVal Tensor roll(@ByVal @Cast("at::IntArrayRef*") Pointer shifts, @ByVal(nullValue = "at::IntArrayRef({})") @Cast("at::IntArrayRef*") Pointer dims);
  public native @ByVal Tensor roll(@ByVal @Cast("at::IntArrayRef*") Pointer shifts);
  public native @ByVal Tensor rot90(@Cast("int64_t") long k/*=1*/, @ByVal(nullValue = "at::IntArrayRef({0,1})") @Cast("at::IntArrayRef*") Pointer dims);
  ...
  public native @ByVal Tensor var(@ByVal @Cast("at::IntArrayRef*") Pointer dim, @Cast("bool") boolean unbiased/*=true*/, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor var(@ByVal @Cast("at::IntArrayRef*") Pointer dim);
  ...
  public native @ByVal Tensor norm(@ByVal @Cast("c10::optional<at::Scalar>*") Pointer p, @ByVal ScalarType dtype);
  public native @ByVal Tensor norm(@ByVal(nullValue = "at::Scalar(2)") Scalar p);
  public native @ByVal Tensor norm();
  public native @ByVal Tensor norm(@ByVal @Cast("c10::optional<at::Scalar>*") Pointer p, @ByVal @Cast("at::IntArrayRef*") Pointer dim, @Cast("bool") boolean keepdim, @ByVal ScalarType dtype);
  public native @ByVal Tensor norm(@ByVal @Cast("c10::optional<at::Scalar>*") Pointer p, @ByVal @Cast("at::IntArrayRef*") Pointer dim, @Cast("bool") boolean keepdim/*=false*/);
  public native @ByVal Tensor norm(@ByVal @Cast("c10::optional<at::Scalar>*") Pointer p, @ByVal @Cast("at::IntArrayRef*") Pointer dim);
  public native @ByVal Tensor clone(@ByVal(nullValue = "c10::optional<at::MemoryFormat>(c10::nullopt)") @Cast("c10::optional<at::MemoryFormat>*") Pointer memory_format);
  public native @ByVal Tensor clone();
  public native @ByRef Tensor resize_as_(@Const @ByRef Tensor the_template, @ByVal(nullValue = "c10::optional<at::MemoryFormat>(c10::nullopt)") @Cast("c10::optional<at::MemoryFormat>*") Pointer memory_format);
  ...
  public native @ByVal Tensor sub(@Const @ByRef Tensor other, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor sub(@Const @ByRef Tensor other);
  public native @ByRef Tensor sub_(@Const @ByRef Tensor other, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByRef Tensor sub_(@Const @ByRef Tensor other);
  public native @ByVal Tensor sub(@ByVal Scalar other, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor sub(@ByVal Scalar other);
  public native @ByRef Tensor sub_(@ByVal Scalar other, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByRef Tensor sub_(@ByVal Scalar other);
  public native @ByVal Tensor addmm(@Const @ByRef Tensor mat1, @Const @ByRef Tensor mat2, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor addmm(@Const @ByRef Tensor mat1, @Const @ByRef Tensor mat2);
  public native @ByRef Tensor addmm_(@Const @ByRef Tensor mat1, @Const @ByRef Tensor mat2, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByRef Tensor addmm_(@Const @ByRef Tensor mat1, @Const @ByRef Tensor mat2);
  public native @ByRef Tensor sparse_resize_(@ByVal @Cast("at::IntArrayRef*") Pointer size, @Cast("int64_t") long sparse_dim, @Cast("int64_t") long dense_dim);
  public native @ByRef Tensor sparse_resize_and_clear_(@ByVal @Cast("at::IntArrayRef*") Pointer size, @Cast("int64_t") long sparse_dim, @Cast("int64_t") long dense_dim);
  ...
  public native @StdVector Tensor unbind(@Cast("int64_t") long dim/*=0*/);
  public native @StdVector Tensor unbind();
  public native @StdVector Tensor unbind(@ByVal Dimname dim);
  ...
  public native @ByVal Tensor to(@Const @ByRef TensorOptions options, @Cast("bool") boolean non_blocking/*=false*/, @Cast("bool") boolean copy/*=false*/, @ByVal(nullValue = "c10::optional<at::MemoryFormat>(c10::nullopt)") @Cast("c10::optional<at::MemoryFormat>*") Pointer memory_format);
  public native @ByVal Tensor to(@Const @ByRef TensorOptions options);
  public native @ByVal Tensor to(@ByVal Device device, @ByVal ScalarType dtype, @Cast("bool") boolean non_blocking/*=false*/, @Cast("bool") boolean copy/*=false*/, @ByVal(nullValue = "c10::optional<at::MemoryFormat>(c10::nullopt)") @Cast("c10::optional<at::MemoryFormat>*") Pointer memory_format);
  public native @ByVal Tensor to(@ByVal Device device, @ByVal ScalarType dtype);
  public native @ByVal Tensor to(@ByVal ScalarType dtype, @Cast("bool") boolean non_blocking/*=false*/, @Cast("bool") boolean copy/*=false*/, @ByVal(nullValue = "c10::optional<at::MemoryFormat>(c10::nullopt)") @Cast("c10::optional<at::MemoryFormat>*") Pointer memory_format);
  public native @ByVal Tensor to(@ByVal ScalarType dtype);
  public native @ByVal Tensor to(@Const @ByRef Tensor other, @Cast("bool") boolean non_blocking/*=false*/, @Cast("bool") boolean copy/*=false*/, @ByVal(nullValue = "c10::optional<at::MemoryFormat>(c10::nullopt)") @Cast("c10::optional<at::MemoryFormat>*") Pointer memory_format);
  public native @ByVal Tensor to(@Const @ByRef Tensor other);
  public native @ByVal Scalar item();
  public native @ByRef Tensor set_(@ByVal @Cast("at::Storage*") Pointer source);
  public native @ByRef Tensor set_(@ByVal @Cast("at::Storage*") Pointer source, @Cast("int64_t") long storage_offset, @ByVal @Cast("at::IntArrayRef*") Pointer size, @ByVal(nullValue = "at::IntArrayRef({})") @Cast("at::IntArrayRef*") Pointer stride);
  public native @ByRef Tensor set_(@ByVal @Cast("at::Storage*") Pointer source, @Cast("int64_t") long storage_offset, @ByVal @Cast("at::IntArrayRef*") Pointer size);
  public native @ByRef Tensor set_(@Const @ByRef Tensor source);
  public native @ByRef Tensor set_();
  public native @ByRef Tensor set_quantizer_(@ByVal @Cast("at::ConstQuantizerPtr*") Pointer quantizer);
  ...
  public native @ByVal Tensor view(@ByVal @Cast("at::IntArrayRef*") Pointer size);
  ...
  public native @ByRef Tensor addbmm_(@Const @ByRef Tensor batch1, @Const @ByRef Tensor batch2, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByRef Tensor addbmm_(@Const @ByRef Tensor batch1, @Const @ByRef Tensor batch2);
  public native @ByVal Tensor addbmm(@Const @ByRef Tensor batch1, @Const @ByRef Tensor batch2, @ByVal(nullValue = "at::Scalar(1)") Scalar beta, @ByVal(nullValue = "at::Scalar(1)") Scalar alpha);
  public native @ByVal Tensor addbmm(@Const @ByRef Tensor batch1, @Const @ByRef Tensor batch2);
  public native @ByRef Tensor addcdiv_(@Const @ByRef Tensor tensor1, @Const @ByRef Tensor tensor2, @ByVal(nullValue = "at::Scalar(1)") Scalar value);
  public native @ByRef Tensor addcdiv_(@Const @ByRef Tensor tensor1, @Const @ByRef Tensor tensor2);
  public native @ByRef Tensor random_(@Cast("int64_t") long from, @ByVal @Cast("c10::optional<int64_t>*") Pointer to, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByRef Tensor random_(@Cast("int64_t") long from, @ByVal @Cast("c10::optional<int64_t>*") Pointer to);
  public native @ByRef Tensor random_(@Cast("int64_t") long to);
  public native @ByRef Tensor random_(@ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByRef Tensor random_();
  public native @ByRef Tensor uniform_(double from/*=0*/, double to/*=1*/, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByRef Tensor uniform_();
  public native @ByRef Tensor cauchy_(double median/*=0*/, double sigma/*=1*/, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByRef Tensor cauchy_();
  public native @ByRef Tensor log_normal_(double mean/*=1*/, double std/*=2*/, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByRef Tensor log_normal_();
  public native @ByRef Tensor exponential_(double lambd/*=1*/, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  public native @ByRef Tensor exponential_();
  public native @ByRef Tensor geometric_(double p, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  ...
  public native @ByVal Tensor cross(@Const @ByRef Tensor other, @ByVal(nullValue = "c10::optional<int64_t>(c10::nullopt)") @Cast("c10::optional<int64_t>*") Pointer dim);
  ...
  public native @StdVector Tensor nonzero_numpy();
  ...
  public native @ByVal Tensor addcmul(@Const @ByRef Tensor tensor1, @Const @ByRef Tensor tensor2, @ByVal(nullValue = "at::Scalar(1)") Scalar value);
  public native @ByVal Tensor addcmul(@Const @ByRef Tensor tensor1, @Const @ByRef Tensor tensor2);
  public native @ByRef Tensor addcmul_(@Const @ByRef Tensor tensor1, @Const @ByRef Tensor tensor2, @ByVal(nullValue = "at::Scalar(1)") Scalar value);
  public native @ByRef Tensor addcmul_(@Const @ByRef Tensor tensor1, @Const @ByRef Tensor tensor2);
  public native @ByVal Tensor addcdiv(@Const @ByRef Tensor tensor1, @Const @ByRef Tensor tensor2, @ByVal(nullValue = "at::Scalar(1)") Scalar value);
  public native @ByVal Tensor addcdiv(@Const @ByRef Tensor tensor1, @Const @ByRef Tensor tensor2);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer lstsq(@Const @ByRef Tensor A);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer triangular_solve(@Const @ByRef Tensor A, @Cast("bool") boolean upper/*=true*/, @Cast("bool") boolean transpose/*=false*/, @Cast("bool") boolean unitriangular/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer triangular_solve(@Const @ByRef Tensor A);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer symeig(@Cast("bool") boolean eigenvectors/*=false*/, @Cast("bool") boolean upper/*=true*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer symeig();
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer eig(@Cast("bool") boolean eigenvectors/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer eig();
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor,at::Tensor>*") Pointer svd(@Cast("bool") boolean some/*=true*/, @Cast("bool") boolean compute_uv/*=true*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor,at::Tensor>*") Pointer svd();
  ...
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer solve(@Const @ByRef Tensor A);
  public native @ByVal Tensor cholesky_inverse(@Cast("bool") boolean upper/*=false*/);
  public native @ByVal Tensor cholesky_inverse();
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer qr(@Cast("bool") boolean some/*=true*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer qr();
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer geqrf();
  ...
  public native @ByVal Tensor multinomial(@Cast("int64_t") long num_samples, @Cast("bool") boolean replacement/*=false*/, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
  ...
  public native @ByVal Tensor dist(@Const @ByRef Tensor other, @ByVal(nullValue = "at::Scalar(2)") Scalar p);
  ...
  public native @ByVal Tensor histc(@Cast("int64_t") long bins/*=100*/, @ByVal(nullValue = "at::Scalar(0)") Scalar min, @ByVal(nullValue = "at::Scalar(0)") Scalar max);
  ...
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer sort(@Cast("int64_t") long dim/*=-1*/, @Cast("bool") boolean descending/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer sort();
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer sort(@ByVal Dimname dim, @Cast("bool") boolean descending/*=false*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer sort(@ByVal Dimname dim);
  ...
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer topk(@Cast("int64_t") long k, @Cast("int64_t") long dim/*=-1*/, @Cast("bool") boolean largest/*=true*/, @Cast("bool") boolean sorted/*=true*/);
  public native @ByVal @Cast("std::tuple<at::Tensor,at::Tensor>*") Pointer topk(@Cast("int64_t") long k);
  ...
  public native @ByRef Tensor normal_(double mean/*=0*/, double std/*=1*/, @ByVal(nullValue = "c10::optional<at::Generator>(c10::nullopt)") @Cast("c10::optional<at::Generator>*") Pointer generator);
