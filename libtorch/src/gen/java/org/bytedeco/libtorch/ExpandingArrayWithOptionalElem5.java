...
@Name("torch::ExpandingArrayWithOptionalElem<5>") @Properties(inherit = org.bytedeco.libtorch.presets.libtorch.class)
public class ExpandingArrayWithOptionalElem5 extends Pointer {
    static { Loader.load(); }
   ...
   *  The extent of the length is checked against the {@code ExpandingArrayWithOptionalElem}'s extent parameter {@code D}
   *  at runtime. */
  /*implicit*/ public ExpandingArrayWithOptionalElem5(@StdVector T vec) { super((Pointer)null); allocate(vec); }
private native void allocate(@StdVector T vec);
   ...
   *  The extent of the length is checked against the {@code ExpandingArrayWithOptionalElem}'s extent parameter {@code D}
   *  at runtime. */
  /*implicit*/ public ExpandingArrayWithOptionalElem5(@ByVal @Cast("at::ArrayRef<T>*") Pointer values) { super((Pointer)null); allocate(values); }
