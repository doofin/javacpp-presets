...
public class Device extends Pointer {
   ...
   *  index. */
  /* implicit */ public Device(@Cast("c10::DeviceType") short type, @Cast("c10::DeviceIndex") short index/*=-1*/) { super((Pointer)null); allocate(type, index); }
private native void allocate(@Cast("c10::DeviceType") short type, @Cast("c10::DeviceIndex") short index/*=-1*/);
public Device(@Cast("c10::DeviceType") short type) { super((Pointer)null); allocate(type); }
private native void allocate(@Cast("c10::DeviceType") short type);
...
private native void allocate(@StdString String device_string);
   ...
   *  {@code other}. */
  public native @Cast("bool") @Name("operator ==") @NoException boolean equals(@Const @ByRef Device other);

  /** Returns true if the type or index of this {@code Device} differs from that of
   *  {@code other}. */
  public native @Cast("bool") @Name("operator !=") @NoException boolean notEquals(@Const @ByRef Device other);

  /** Sets the device index. */
  public native void set_index(@Cast("c10::DeviceIndex") short index);

  /** Returns the type of device this is. */
  public native @Cast("c10::DeviceType") @NoException short type();

  /** Returns the optional index. */
  public native @Cast("c10::DeviceIndex") @NoException short index();
