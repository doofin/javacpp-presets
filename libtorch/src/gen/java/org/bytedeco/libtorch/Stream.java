...
public class Stream extends Pointer {
  ...
  /** enum c10::Stream::Unsafe */
  public static final int UNSAFE = 0;
  /** enum c10::Stream::Default */
  ...
  public native @Cast("bool") @Name("operator ==") @NoException boolean equals(@Const @ByRef Stream other);
  public native @Cast("bool") @Name("operator !=") @NoException boolean notEquals(@Const @ByRef Stream other);

  public native @ByVal @NoException Device device();
  public native @Cast("c10::DeviceType") @NoException short device_type();
  public native @Cast("c10::DeviceIndex") @NoException short device_index();
