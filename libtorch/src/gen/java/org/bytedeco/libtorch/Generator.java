...
public class Generator extends Pointer {
    ...
    @Override public Generator getPointer(long i) {
        return new Generator(this).position(position + i);
    }

  public Generator() { super((Pointer)null); allocate(); }
  private native void allocate();

  public Generator(@ByVal @Cast("c10::intrusive_ptr<c10::GeneratorImpl>*") Pointer gen_impl) { super((Pointer)null); allocate(gen_impl); }
  private native void allocate(@ByVal @Cast("c10::intrusive_ptr<c10::GeneratorImpl>*") Pointer gen_impl);
  ...
  public native @Cast("const c10::intrusive_ptr<c10::GeneratorImpl>*") @ByRef Pointer getIntrusivePtr();
